...
/**
 *  Recupera el grafo del fichero especificado y lo almacena
 *  en una estructura de datos de tipo Grafo.
 */
void cargar_grafo(ifstream &f, Grafo &grafo)
{
    ...
    bool G[num_productos][num_productos];
    int num_aristas = 0;
